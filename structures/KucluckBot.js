...
class KucluckBot extends Client {
  constructor(props) {
    super(props);
    ...
    this.Manager = new Manager({
      ...
      .on("queueEnd", (player) => {
        client.channels.cache.get(player.textChannel).send(`Left the voice channel due the playlist has ended. \n if you like the music features of Kucluck bot, check out Kucluck Premium for better quality. https://kucluck.com/premium`);
